...
class TwitchChat {
    constructor(options = {}, io) {
        ...
        this.Client.on("connected", () => {
            Con.Log("Successfully connected to Twitch Chat");
        });
        this.Client.on("disconnected", () => {
            Reconnect("Client Disconnected, attempting to reconnect in 5 minutes.");
        });
        this.Client.on("connectfail", () => {
            Reconnect("Failed to connect, attmpeting to reconnect in 5 minutes.");
        });
