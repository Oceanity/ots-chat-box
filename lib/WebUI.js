...
class WebUI {
    constructor(options = {}) {
        ...
        // Display settings
        this.showBadges = typeof options.showBadges !== 'undefined' ? options.showBadges : true;
        this.inlineMessages = typeof options.inlineMessages !== 'undefined' ? options.inlineMessages : false;
        this.mergeMessages = typeof options.mergeMessages !== 'undefined' ? options.mergeMessages : true;
        this.alternateBackground = typeof options.alternateBackground !== 'undefined' ? options.alternateBackground : false;
        ...
        this.sockets.on("connection", (socket) => {
            ...
            socket.on("handshake", (data) => {
                // Pass display settings to web client
                socket.emit("config", {
                    showBadges: this.showBadges,
                    inlineMessages: this.inlineMessages,
                    mergeMessages: this.mergeMessages,
                    alternateBackground: this.alternateBackground
                });
